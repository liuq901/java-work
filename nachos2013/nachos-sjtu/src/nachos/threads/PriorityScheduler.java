...
public class PriorityScheduler extends Scheduler {
	...
	protected class PriorityQueue extends ThreadQueue {
		...
		public KThread nextThread() {
			...
			if (!waitQueue.isEmpty()) {
				...
				allState.remove(now);
				now.belong = null;
				maximum = waitQueue.isEmpty() ? priorityMinimum : waitQueue
						.firstKey().priority;
	...
	protected class ThreadState implements Comparable<ThreadState> {
		...
		public void waitForAccess(PriorityQueue waitQueue) {
			...
			belong.insert(this);
			if (belong.transferPriority
					&& getEffectivePriority() > belong.maximum)
				belong.modify(this);
		}
		...
		public int compareTo(ThreadState a) {
			return (thread.PID() - a.thread.PID());
		}
		...
		Pair hash() {
			return (new Pair(getEffectivePriority(), time, thread.PID()));
		}
